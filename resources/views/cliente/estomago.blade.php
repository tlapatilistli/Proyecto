...
<nav>
 ...
 <ol class="breadcrumb">
   ...
   <li class="breadcrumb-item "><a href="{{ route('comunes') }}" class="text"> Enfermedades comunes</a></li>

   <li class="breadcrumb-item active"><a href="" class="text">Dolor de estomago</a></li>
    ...
    <div class="Introduction">
         <div class="container">
               <h2>Dolor de estomago</h2>
                <p class="plain-text">Ingredientes:<br><br>

                1 cucharadita de hinojo (5 g)<br>
                1 taza de agua (250 ml)<br><br>


¿Cómo prepararlo?<br>

Coloca a hervir la taza de agua, agrégale el hinojo y déjala a fuego bajo durante 3 minutos.<br>
Retírala, deja que repose otros 15 minutos, filtra y consúmela.
</p><br>

<center><IMG SRC="../img/comun/estomago.jpeg" width="450"></center>
<br> 
