...
<nav>
 ...
 <ol class="breadcrumb">
   ...
   <li class="breadcrumb-item active"><a href="" class="text">Hemorragia</a></li>
    ...
    <div class="Introduction">
         <div class="container">
               <h2>Hemorragias</h2>
                <p class="plain-text">Cubra la herida con un paño limpio y aplique la presión empujando directamente sobre ella con ambas manos.<br>
Si la hemorragia presenta peligro para la vida en un brazo o pierna y un torniquete está disponible:<br><br> Coloque el torniquete.
Para una hemorragia con peligro para la vida en brazo o pierna y el torniquete no está disponible o, la hemorragia es en el cuello, hombro o ingle:<br><br> Rellene la herida con gasa o ropa limpia aplicando presión con ambas manos.<br>
Mantenga la presión hasta detener la hemorragia o llegue personal médico.
</p><br>

<center><IMG SRC="../img/auxilios/hemorragia.jpg" width="450"></center>
<br> 
