...
<nav>
 ...
 <ol class="breadcrumb">
   ...
   <li class="breadcrumb-item"><a href="{{ route('remedios') }}" class="text"> Remedios caseros</a></li>

   <li class="breadcrumb-item active"><a href="" class="text"> Enfermedades comunes</a></li>
   ...
   <div class="portfolio-item">
        <section  id="remedios">
            <div class="container"><br><br>
                ...
                <h2 class="section-heading text-uppercase">Enfermedades comunes</h2><br>
    ...
    <div id="container" >
        ...
        <div id="containerprod" > 
            <img src="../img/comun/cabeza.jpeg">
            <br>
        
            <center> <h5>Dolor de cabeza</h5></center>
        </div></a>

        <a href="{{ route('estomago') }}">
        <div id="containerprod" > 
            <img src="../img/comun/estomago.jpeg">
            <br>
        
            <center> <h5>Dolor de estomago</h5></center>
        </div></a>

        <a href="{{ route('garganta') }}">
        <div id="containerprod" > 
            <img src="../img/comun/garganta.jpeg">
            <br>
        
            <center> <h5>Dolor de garganta</h5></center>
        </div></a>

        <a href="{{ route('mareo')}}">
        <div id="containerprod" > 
            <img src="../img/comun/mareo.jpeg">
            <br>
            <center> <h5>Mareo</h5></center>
        </div></a>

        <a href="{{ route('resfriado') }}">
        <div id="containerprod" > 
            <img src="../img/comun/resfriado.jpeg">
            <br>
            <center> <h5>Resfriado</h5></center>
        </div></a>
