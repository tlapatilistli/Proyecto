   ...
   <div class="portfolio-item">
        <section  id="remedios">
            <div class="container"><br><br>
                ...
                <h2 class="section-heading text-uppercase">Menú</h2><br>
    ...
    <div id="container" >
        ...
        <div id="containerprod" > 
            ...
            <center> <h5>Historia</h5></center>
        </div></a>

        <a href="{{ route('tecnicas') }}">
        <div id="containerprod" > 
            <img src="../img/remedios caseros.jpg">
            <br>
        
            <center> <h5>Tecnicas</h5></center>
            <center> <h5>tradicionales</h5></center>
        </div></a>

        <a href="{{ route('remedios') }}">
        <div id="containerprod" > 
            <img src="../img/tasa.jpg">
            <br>
        
            <center> <h5>Remedios</h5></center>
            <center> <h5>caseros</h5></center>
        </div></a>
        ...
        <div id="containerprod" > 
            ...
            <center> <h5>Origen</h5></center>
        </div></a>

        <a href="{{ route('auxilio') }}">
        <div id="containerprod" > 
            <img src="../img/auxilio.jpg">
            <br>
            <center> <h5>Primeros auxilios</h5></center>
        </div></a>
