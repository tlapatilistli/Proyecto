...
<nav>
 ...
 <ol class="breadcrumb">
   ...
   <li class="breadcrumb-item active"><a href="" class="text">Heridas simples</a></li>
    ...
    <div class="Introduction">
         <div class="container">
               <h2>Heridas simples</h2>
                <p class="plain-text">Lávese las manos y deje correr abundante agua sobre la herida. Limpie con jabón neutro la piel que la rodea.<br>
Elimine cuerpos extraños como piedrecillas, tierra, astillas y otros que no estén incrustados.<br>
Aplique antiséptico en los bordes de la herida.<br><br>
Cubra con gasa o apósito estéril, nunca algodón. Fije con tela adhesiva o una venda.
</p><br>

<center><IMG SRC="../img/auxilios/herida.jpg" width="450"></center>
<br> 
