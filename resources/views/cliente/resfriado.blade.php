...
<nav>
 ...
 <ol class="breadcrumb">
   ...
   <li class="breadcrumb-item active"><a href="" class="text">Resfriado</a></li>
    ...
    <div class="Introduction">
         <div class="container">
               <h2>Resfriado</h2>
                ...
                ½ taza de miel de abejas (167 g)<br>
                El jugo de 1 limón<br><br>


¿Cómo prepararlo?<br>

Exprime el jugo de limón y mézclalo con la miel de abejas.<br>
Consume una cucharada cada tres o cuatro horas.
</p><br>

<center><IMG SRC="../img/comun/resfriado.jpeg" width="450"></center>
<br> 
